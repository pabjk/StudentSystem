                    ...
                    <div class="row">
                        <div>
                            <input type="text" id="login_username" name="login_username" placeholder="Email address"
                                style="width: 300px;height: 60px;border: solid 1px #ccc;border-radius: 10px 10px 0 0;font-family: 'OpenSans-Regular';font-size: 18pt;text-indent: 5px;" />
                        </div>
                        <div>
                            <input type="password" id="login_password" name="login_password" placeholder="Password"
                                style="width: 300px;height: 60px;border: solid 1px #ccc;border-radius:0 0 10px 10px ;font-family: 'OpenSans-Regular';font-size: 18pt;text-indent: 5px;" />
                        </div>
                        <div>
    ...
    <div id="register" data-role="view" data-layout="register_layout" data-title="REGISTER"
        ...
        <div data-role="content">
            <div style="margin-top:50px;padding-bottom: 20px;" class="roundbox1">
                ...
                <div style="text-align:center;color: #333333;font-size: 10.0pt;font-family:'OpenSans-Regular'"></div>
    ...
    <section data-role="layout" data-id="register_layout">
        <div data-role="header">
            ...
            <div id="register_layout_title"
                style="position: fixed;top: 10px;left: 50%;-webkit-transform: translate(-50%, 0);transform: translate(-50%, 0);width: fit-content;color: #493D45;font-size: 14.0pt;font-family:'OpenSans-SemiBold';">
                &nbsp;</div>
        </div>
    </section>
    <!-- /template -->
