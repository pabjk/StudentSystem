...
.mastfoot {
  ...
  <main role="main" class="inner cover">
    <h1 class="cover-heading">401</h1>
    <p class="lead"><i class="fa fa-warning" style="color:yellow"></i>Oops! You are not authorized.</p>
    <p class="lead">You are not authorized to access this page.</p>
    <p class="lead">
      <a href="index.php" class="btn btn-lg btn-secondary">return to login</a>
    </p>
  </main>
